...
public class Constant {
	...
	public static final Arr[] dietArr = {new Arr(1,"素食"),new Arr(2,"清真餐"),new Arr(20,"其它")};
	...
	public static final Arr[] roomArr = {new Arr(1,"一人一间（价格： ）"),new Arr(2,"二人一间（价格： ）")};
	public static final Arr[] trafficArr = {new Arr(1,"飞机"),new Arr(2,"自驾"),new Arr(20,"其他")};
	public static final Arr[] touristArr = {new Arr(1,"A、东莞可园、石排塘尾古村、松山湖一日游"),new Arr(2,"B、香港自由行"),new Arr(3,"C、高尔夫")};
